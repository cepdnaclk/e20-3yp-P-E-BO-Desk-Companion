...
class AudioNode:
    def __init__(self, listen_port=8888, target_host='172.20.10.12', target_port=8888):
...
if __name__ == "__main__":
    node = AudioNode(
        listen_port=8888,      # Pi 2 listens on this port
        target_host='172.20.10.12', # Pi 1 IP
        target_port=8888       # Pi 1 listens on this port
    )
    node.start()
