...
Monitors Firebase tasks every minute, plays a sound and speaks the task description with time remaining for reminders,
repeats for 1 minute or until a double-tap is detected on the touch sensor.
...
async def reminder_loop():
    """Main loop to check Firebase for reminders every minute."""
    # Initialize Firebase
    try:
