...
Modified for two separate I2C OLED displays

Original Copyright (C) 2024 Dennis Hoelscher
Modified for dual display setup
"""
...
class RoboEyesDual:
    def __init__(self, left_address=0x3C, right_address=0x3D):
        ...
        # Create two displays - one for each eye
        ...
        # Eye geometry - LEFT
        self.eye_l_width_default = 48  # Larger since it's the only eye on the display
        self.eye_l_height_default = 48
    ...
    def set_position(self, position):
        ...
        offset_x = 30  # How far from center to move
        offset_y = 20
    ...
    def draw_eyes(self):
        ...
        # Display the images on both displays
        self.display_left.image(image_left)
        self.display_left.show()
        
        self.display_right.image(image_right)
        self.display_right.show()
