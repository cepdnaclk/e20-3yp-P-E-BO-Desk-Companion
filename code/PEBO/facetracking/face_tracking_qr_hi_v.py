...
Modified to run without the vertical (v) servo: Removed all references and control logic for the v_servo.
"""
...
class CombinedFaceTracking:
    ...
    def __init__(self):
        ...
        # Dual servo parameters (removed v-related)
